...
Revenue by category shows how much income each product category generates. The vehicle category has the highest revenue, which may be because these products are more expensive. Men’s watches also generate high revenue, followed closely by women’s watches, showing that these products are popular among customers.
